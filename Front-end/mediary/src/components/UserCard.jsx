...
function UserCard() {
  return (
    <div className="w-full max-w-md p-6 bg-white rounded-2xl border border-gray-200 shadow-xs">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Lover of books, music, and movies!</p>
        </div>
      </div>
